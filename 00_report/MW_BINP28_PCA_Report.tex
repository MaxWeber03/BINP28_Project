...
The filtered variants were converted from vcf to SNPRelate's gds format, LD pruning was performed on the whole genome (both available chromosomes) with a threshold of r = 0.2. The threshold was choosen as it is the default in the SNPRelate documentation and finding a more appropriate threshold through a LD decay plot was giving unexpected results (see \nameref{discussion}).
This excluded a large proportion of the samples, reducing the number of variants from 112,329 to just 2,354, which is suspicously low.
